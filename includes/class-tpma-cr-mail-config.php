...
class TPMA_CR_Mail_Config
{
    ...
    protected static function get_default_config()
    {
        return [
            ...
            // 共通尾巴
            'common_footer_html' => '<p style="font-size:12px;color:#555;">
                —<br />
                聯絡資訊：<br />
                台灣專案管理學會 TPMA 課程承辦單位<br />
                電話：請填入您的聯絡電話<br />
                Email：請填入您的聯絡信箱<br />
                👉 深入了解 TPMA  <a href="http://www.tw-pma.org.tw">http://www.tw-pma.org.tw</a><br /><br />
                重要提醒：本信件為系統自動發送，請勿直接回覆。如有任何問題，歡迎與 TPMA 課程承辦人聯繫。
            </p>',
        ];
    }
}
